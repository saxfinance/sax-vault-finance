...
contract StrategyEllipsis is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    uint256 public safetyCoeffNumer;
    uint256 public safetyCoeffDenom;
    ...
    function setSafetyCoeff(uint256 _safetyNumer, uint256 _safetyDenom) public onlyOwner{
