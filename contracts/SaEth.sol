...
contract SaEth is AccessControl, ERC20("SA ETH", "saETH") {
  ...
  modifier onlyWhitelisted() {
    require(whiteList[msg.sender], "AlETH: Saxophone is not whitelisted");
    _;
  }
  ...
  function mint(address _recipient, uint256 _amount) external onlyWhitelisted {
    require(!paused[msg.sender], "AlETH: Saxophone is currently paused.");
